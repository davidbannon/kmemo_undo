...
{    Copyright (C) 2021 David Bannon
    ...
    That being said, there is nothing of any great significence here in this
    file, if you copy some part of it, you should regard that as fair dealing
    and incure no obligation to retain this license or copyright.

    ------------------

    A very simple demo of how to use the tbundo unit to enable undo/redo
    on a KMemo component.
}
